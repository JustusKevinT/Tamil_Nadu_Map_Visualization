! function(e, t) {
	...
	var t = L.MarkerClusterGroup = L.FeatureGroup.extend({
		...
		addLayers: function(n, s) {
			...
			if (this._map) {
				...
				for (var e = this._needsClustering; p < d; p++)(o = n[p]) instanceof L.LayerGroup ? (c && (n = n.slice(), c = !1), this._extractNonGroupLayers(o, n), d = n.length) : o.getLatLng ? this.hasLayer(o) || e.push(o) : h.addLayer(o);
			return this
		},
		...
		eachLayer: function(e, t) {
			var i, r, n, s = this._needsClustering.slice(),
	...
	L.MarkerClusterGroup.include({
		...
		_withAnimation: {
			...
			_animationZoomIn: function(n, s) {
				var o, a = this._getExpandedVisibleBounds(),
	...
	var i = L.MarkerCluster = L.Marker.extend({
		...
		_recursivelyRestoreChildPositions: function(e) {
			...
			if (e - 1 === this._zoom)
				for (var r = this._childClusters.length - 1; 0 <= r; r--) this._childClusters[r]._restorePosition();
			else
				for (var n = this._childClusters.length - 1; 0 <= n; n--) this._childClusters[n]._recursivelyRestoreChildPositions(e)
		},
		...
		_recursively: function(e, t, i, r, n) {
			...
			if (t <= h && (r && r(this), n && h === i && n(this)), h < t || h < i)
				for (s = a.length - 1; 0 <= s; s--)(o = a[s])._boundsNeedUpdate && o._recalculateBounds(), e.intersects(o._bounds) && o._recursively(e, t, i, r, n)
		},
	...
	L.Marker.include({
		...
		getNearObject: function(e) {
			var t, i, r, n, s, o, a, h, l = this._getCoord(e.x),
			...
			for (t = u - 1; t <= u + 1; t++)
				if (n = this._grid[t])
					for (i = l - 1; i <= l + 1; i++)
						if (s = n[i])
							for (r = 0, o = s.length; r < o; r++) a = s[r], ((h = this._sqDist(_[L.Util.stamp(a)], e)) < d || h <= d && null === p) && (d = h, p = a);
			return p
		},
		...
		_generatePointsCircle: function(e, t) {
			var i, r, n = this._group.options.spiderfyDistanceMultiplier * this._circleFootSeparation * (2 + e) / this._2PI,
				s = this._2PI / e,
				o = [];
		...
		_generatePointsSpiral: function(e, t) {
			var i, r = this._group.options.spiderfyDistanceMultiplier,
